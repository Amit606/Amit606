...
`SDK Architecture` `API Design` `Push Notifications` `Analytics`
...
`OpenAI` `Gemini` `LLMs` `Prompt Engineering` `RAG`
...
https://mvnrepository.com/artifact/com.izooto/android-sdk

**iOS**

https://cocoapods.org/pods/iZootoiOSSDK
